...
const ComponentLibraryFilters = ({
  ...
  const categories: Array<{ key: ComponentCategory | 'all'; label: string; icon: any }> = [
...
const ComponentLibraryExample = () => {
  ...
  const [canvasComponents, setCanvasComponents] = useState<Array<{ id: string; component: ComponentMeta; props: any }>>([])
