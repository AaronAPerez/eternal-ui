// =================================================================
// COMPLETE VISUAL BUILDER INTEGRATION
// packages/studio/src/components/VisualBuilder/VisualBuilder.tsx
// =================================================================
...
import { CanvasProvider, Canvas, CanvasToolbar, useCanvas } from './CanvasSystem'
import {
  DragDropInterface,
  ComponentLibrary,
  DropZone,
  QuickActions,
  COMPONENT_LIBRARY
} from './DragDropInterface'
import { LivePreview, ResponsivePreview, PREVIEW_DEVICES } from './PreviewSystem'
import { CodeExportPanel, CodeExporter } from './CodeExportSystem'
